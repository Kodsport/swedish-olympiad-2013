...
mellan två punkter \textbf{P} och \textbf{Q} i ett regelbundet rutnät beskriver hur många kanter
...
\section*{Indata}
Den första raden av indata innehåller två heltal $N$ och $M$ ($1 \leq N, M \leq 10^5$), antalet vänner
