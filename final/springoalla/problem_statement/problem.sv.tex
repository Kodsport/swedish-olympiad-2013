...
\section*{Indata}
På första raden står två heltal $n$ och $t$ ($1 \leq n \leq 1000$, $1 \le t \le 10^5$), antalet löpspår och tiden som Springoalla vill löpträna.
Talet $t$ behöver däremot inte vara jämnt.

På andra raden står $n$ stycken heltal $l_i$, där $2 \le l_i \le 40{,}000$ kommer vara ett jämnt heltal och är antalet minuter det tar att springa löpspår $i$.
